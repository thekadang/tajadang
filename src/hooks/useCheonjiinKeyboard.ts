...
export const useCheonjiinKeyboard = (stepId: number = 4) => {
  ...
  }, [currentStep, currentPressCount, pressInfo, currentInputIndex, inputSequence, isCompleted, currentWord, loadNewWord, consecutiveSuccess, currentLevel, startKeyTimeTimer]);
